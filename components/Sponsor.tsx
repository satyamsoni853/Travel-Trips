...
const Sponsor = ({
  ...
  // FIX: Set titleColorClass to purple in both dark (text-purple-400) and light (text-purple-700) mode.
    ...
    <section className="relative py-12">
      <div className="max-container padding-container">
        ...
        <div className="text-center mb-3">
          <h3 className={`text-4xl font-extrabold ${titleColorClass} tracking-tight`}>{title}</h3>
        </div>
